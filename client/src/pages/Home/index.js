...
//import { linearGradient } from "react-router-dom";
                        ...
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Collect or sell artwork.Come and dicover a world of art.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Collect or sell sports cards.Come and dicover a world of art..</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Media Art</h3>
                                    <p class="text-sm mb-0">Collect or sell media art.Come and dicover a world of art..</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Music Art</h3>
                                    <p class="text-sm mb-0">Collect or sell music art.Come and dicover a world of art.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Collection</h3>
                                    <p class="text-sm mb-0">Collect or sell all art genres.Come and dicover a world of art.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Artist</h3>
                                    <p class="text-sm mb-0">Meet your favorite artist.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-sm">
                    <div class="media-inner section-inner">
                        <div class="media-header text-center">
                            <h2 class="section-title mt-0">Meet Digi Art Team</h2>
                            <p class="section-paragraph mb-0">Hassan Y, James D, Burak A, and Anne J.</p>
                        </div>
